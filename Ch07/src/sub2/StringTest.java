...
public class StringTest {
	public static void main(String[] args) {
		...
		System.out.println("일곱번째 문자 : " + c7);
		
		// 문자열 자르기
		String sub1 = message.substring(0, 5); // 0~4까지 문자열 자르기
		...
		// 문자열 인덱스
		int index1 = message.indexOf("l"); // 문자열 앞에서부터 탐색 후 인덱스 반환
		int index2 = message.lastIndexOf("l"); // 문자열 뒤에서부터 탐색 후 인덱스 반환
		...
		String result1 = String.valueOf(var1);
		String result2 = String.valueOf(var2);
